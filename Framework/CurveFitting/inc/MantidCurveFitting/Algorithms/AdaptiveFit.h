...
#ifndef MANTID_CURVEFITTING_ADAPTIVEFIT_H_
#define MANTID_CURVEFITTING_ADAPTIVEFIT_H_
...
*/
class DLLExport AdaptiveFit : public IFittingAlgorithm {
public:
...
#endif /* MANTID_CURVEFITTING_ADAPTIVEFIT_H_ */
